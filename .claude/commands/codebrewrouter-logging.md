...
Read `Docs/engineering/logging-contract.md` first, then use `.github/agents/codebrewrouter-logging.agent.md` for the Copilot CLI agent contract when an agent handoff is available.
